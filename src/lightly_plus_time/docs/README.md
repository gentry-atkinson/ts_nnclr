...
```
LIGHTLY_SERVER_LOCATION='https://api.lightly_plus_time.lightly.ai' TOKEN='YOUR_TOKEN' AL_TUTORIAL_DATASET_ID='YOUR_DATASET_ID' make html && python -m http.server 1234 -d build/html
```
